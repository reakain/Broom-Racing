...
public static class ConvexHull
{
    ...
    // source: https://www.habrador.com/tutorials/math/8-convex-hull/
    public static List<Vertex> GetConvexHull_XY(List<Vertex> points)
    {
    ...
    public static List<Vertex> GetConvexHull_XZ(List<Vertex> points)
    {
        //If we have just 3 points, then they are the convex hull, so return those
        if (points.Count == 3)
        {
